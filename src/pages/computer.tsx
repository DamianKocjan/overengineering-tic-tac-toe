...
// Player vs Computer Tic Tac Toe page
const Computer: NextPage = () => {
	...
	const getRandomFreeSquareIndex = (): number =>
		Math.floor(Math.random() * squares.filter((square) => !square).length);
	...
	const computerMove = () => {
		const computerMoveIndex = getRandomFreeSquareIndex;
		const newSquares = [...squares];

		newSquares[computerMoveIndex()] = isXNext ? "O" : "X";
